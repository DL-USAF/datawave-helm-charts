...
from utilities import Retry, setup_logger, assert_test, log_test_start
from constants import namespace


@pytest.fixture(scope='module')
def pods(kube_client: CoreV1Api, log: Logger) -> list[V1Pod]:
...
@Retry(time_limit_min=5, delay_sec=5)
